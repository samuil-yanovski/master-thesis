...
public class AgendaHeaderView extends LinearLayout {
    ...
    public void setDay(Calendar day, int currentDayTextColor) {
        ...
        SimpleDateFormat dayWeekFormatter = new SimpleDateFormat("E", Locale.getDefault());

        Context context = getContext();
        txtDayOfMonth.setTextColor(ContextCompat.getColor(context, R.color.calendar_text_default));
        txtDayOfWeek.setTextColor(ContextCompat.getColor(context, R.color.calendar_text_default));
